function scr_contr_dibujo_personaje_votado(id_comprobar, posX_jug, posY_jug, escala, alfa, rotacion, contr_color) {
	...
	if (jugador_skin!=noone) {
		scr_dibuja_jugador_parado(jugador_skin,posX_jug,posY_jug,alfa, jugador_color,rotacion, jugador_color)
	}
	
	// Dibuja la prenda
	scr_dibuja_prenda_jug_parado(jugador_prenda,0,posX_jug,posY_jug,alfa,escala,escala,rotacion)
