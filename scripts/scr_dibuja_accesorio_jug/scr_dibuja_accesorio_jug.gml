function scr_dibuja_accesorio_jug(argument0, argument1, argument2, argument3, argument4, argument5) {
	...
	switch(accesorio)
	{
		...
		case 32: draw_sprite_ext(spr_mascara23,0,xx+5,yy-(16*escala_y),escala_x,escala_y,0,c_white,alfa)  break
		case 33: draw_sprite_ext(spr_mascara33,0,xx,yy-(3*escala_y),escala_x,escala_y,0,c_white,alfa)  break
		case 34: draw_sprite_ext(spr_mascara32,0,xx-(3*escala_x),yy-(16*escala_y),escala_x,escala_y,0,c_white,alfa)  break
		//case 35: draw_sprite_ext(spr_mascara44,0,xx,yy-(0*escala_y),escala_x,escala_y,0,c_white,alfa)  break
		...
		case 48: draw_sprite_ext(spr_mascara47,0,xx,yy+(7*escala_y),escala_x,escala_y,0,c_white,alfa)  break
		case 49: draw_sprite_ext(spr_mascara48,0,xx,yy+(0*escala_y),escala_x,escala_y,0,c_white,alfa)  break
	}
