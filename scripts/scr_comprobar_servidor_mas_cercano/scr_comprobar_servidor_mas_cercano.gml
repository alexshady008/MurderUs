function scr_comprobar_servidor_mas_cercano(argument0) {
	var servidor = argument0


	var mapaDatos = ds_map_create()
	var bufferDatos = buffer_create(32, buffer_grow, 1)

	ds_map_add(mapaDatos,"mensaje","comprobarServidores")
	...
	network_send_udp_raw(global.cliente,servidor,global.puerto,bufferDatos,tamanio)
