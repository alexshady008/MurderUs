function scr_reportar_muerto(argument0, argument1) {
	var id_pers_reportado = argument0
	var id_pers_informador = argument1

	var mapaDatos = ds_map_create()
	var bufferDatos = buffer_create(32, buffer_grow, 1)

	ds_map_add(mapaDatos,"mensaje","ReportarJugador")
	ds_map_add(mapaDatos,"idJugador_reportado",id_pers_reportado)
