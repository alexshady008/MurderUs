...
#region DIbuja el titulo
	...
	if !(global.tarea_completada)
	{
		...
		switch(os_get_language()) {
			case "es": draw_text_outline("ELIMINA TODOS LOS ICONOS",posX,posY,borde,1,1,color) break;
			case "pt": draw_text_outline("REMOVER TODOS OS ÍCONES",posX,posY,borde,1,1,color) break;
			case "it": draw_text_outline("RIMUOVI TUTTE LE ICONE",posX,posY,borde,1,1,color) break;
			case "ru": draw_set_font(fnt_normal_ru) draw_text_outline("УДАЛИТЬ ВСЕ ЗНАЧКИ",posX,posY,borde,1,1,color) break;
			default: draw_text_outline("REMOVE ALL ICONS",posX,posY,borde,1,1,color) break;
		}
	}	
	else 
	{
