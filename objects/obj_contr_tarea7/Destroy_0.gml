...
#region Destruye los botones
	...
	if instance_exists(obj_btn_eliminar_iconos) instance_destroy(obj_btn_eliminar_iconos)
	if instance_exists(obj_btn_icono_eliminar) instance_destroy(obj_btn_icono_eliminar)
#endregion
