...
#region Destruye los botones
	...
	if instance_exists(obj_btn_aumentar_valor_barra) instance_destroy(obj_btn_aumentar_valor_barra)
	if instance_exists(obj_btn_reducir_valor_barra) instance_destroy(obj_btn_reducir_valor_barra)
#endregion
