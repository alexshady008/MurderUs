...
#region Crea la alarma que asigna un numero de tarea a cada tarea
	if (global.tipo_mapa_a_jugar!="personalizado" ){
		alarm[7] = 5
	}
...
#region Manda el aviso de conexion
	if (global.conectado) {
...
//Avisa al servidor que ya no esta mas en el lobby y que se comenzo la partida
//scr_aviso_comenzar_partida()
