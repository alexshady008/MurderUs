...
#region Destruye los botones
	...
	if instance_exists(obj_postner_superior) instance_destroy(obj_postner_superior)
	if instance_exists(obj_postner_inferior) instance_destroy(obj_postner_inferior)
	if instance_exists(obj_tarj_credito) instance_destroy(obj_tarj_credito)
#endregion
