...
#region DIbuja el titulo
	...
	if !(global.tarea_completada) 
	{
		...
		switch(os_get_language()) {
			case "es": draw_text_outline("DESLIZA LA TARJETA",posX,posY,borde,1,1,color) break;
			case "pt": draw_text_outline("DESLIZE O CARTÃO",posX,posY,borde,1,1,color) break;
			case "it": draw_text_outline("SCORRI LA CARTA",posX,posY,borde,1,1,color) break;
			case "ru": draw_set_font(fnt_normal_ru) draw_text_outline("СМАЗАТЬ КАРТУ",posX,posY,borde,1,1,color) break;
			default: draw_text_outline("SWIPE THE CARD",posX,posY,borde,1,1,color) break;
		}
	}	
	else 
	{
