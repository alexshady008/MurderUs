...
#region controla su posicion
 ...
 if (global.muerto == false and visible==true and global.saboteando==false) {
	if (instance_exists(obj_personaje) and obj_personaje.pers_reportar!=noone and instance_exists(obj_personaje.pers_reportar)) draw_sprite_ext(spr_btnJuego_marcadores,1,x,y,escala,escala,0,c_white,1)
