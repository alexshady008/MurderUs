...
#region DIbuja el titulo
	...
	if !(global.tarea_completada)
	{
		...
		switch(os_get_language()) {
			case "es": draw_text_outline("ELIGE LOS COLORES CORRECTOS",posX,posY,borde,1,1,color) break;
			case "pt": draw_text_outline("ESCOLHA AS CORES CERTAS",posX,posY,borde,1,1,color) break;
			case "it": draw_text_outline("SCEGLI I COLORI GIUSTI",posX,posY,borde,1,1,color) break;
			case "ru": draw_set_font(fnt_normal_ru) draw_text_outline("ВЫБЕРИТЕ ПРАВИЛЬНЫЕ ЦВЕТА",posX,posY,borde,1,1,color) break;
			default: draw_text_outline("CHOOSE THE RIGHT COLORS",posX,posY,borde,1,1,color) break;
		}
	}	
	else 
	{
