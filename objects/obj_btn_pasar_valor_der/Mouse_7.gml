...
if ( global.jugabilidad == false and global.tarea_completada == false ){
	...
	#region Aumenta el valor de las veces apretado
		...
		if (dibujo_actual<dibujo_maximo)  obj_contr_tarea8.icono_actual += 1
		
		//if (dibujo_actual>=dibujo_maximo)  obj_contr_tarea8.icono_actual = 0
		//else if (dibujo_actual<dibujo_maximo)  obj_contr_tarea8.icono_actual += 1
	#endregion
}
