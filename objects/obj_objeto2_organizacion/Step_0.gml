...
#region Comprueba si tiene un objeto al lado
	if (contr_caracteristicas){
		var obj_al_lado = instance_position(x+mov_hor,y,obj_objeto2_organizacion)
		if (obj_al_lado==noone)  obj_al_lado = instance_position(x-mov_hor,y,obj_objeto2_organizacion)
		if (obj_al_lado==noone)  obj_al_lado = instance_position(x,y-mov_vert,obj_objeto2_organizacion)
		if (obj_al_lado==noone)  obj_al_lado = instance_position(x,y+mov_vert,obj_objeto2_organizacion)
