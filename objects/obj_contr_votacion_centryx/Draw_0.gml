...
#region Dibuja el fondo
	draw_sprite(spr_fondo_votacion_centryx, 0, cam_x, cam_y)
	draw_sprite(spr_iluminacion_votacion_centryx, 0, cam_x, cam_y)
#endregion


#region Dibuja la lava
	var posX_lava = cam_x+640
	var posY_lava = cam_y+cam_alto
	draw_sprite_ext(spr_lava_animacion_votacion_cetryx, frame_lava, posX_lava, posY_lava, 1, 1, 0, c_white, 1)
#endregion
...
if (global.estadoJuego == "votacion_finalizada_un_jugador_elegido")
{
	...
	#region Dibuja al diamante
		if (etapa>=5){
			var posX_diamante1 = cam_x+320
			var posX_diamante2 = cam_x+960
			draw_sprite_ext(spr_diamante_votacion_centryx, 0, posX_diamante1, posY_diamante, 1, 1, 0, c_white, 1)
			draw_sprite_ext(spr_diamante_votacion_centryx, 0, posX_diamante2, posY_diamante, 1, 1, 0, c_white, 1)
		}	
	#endregion
