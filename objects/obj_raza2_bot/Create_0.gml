...
#region Variables
	...
	escondido = true //SI el pers se encuentra escondido o no en una alcantarilla
	...
	dist_asesinar = 50  //100
	dist_accionar = 150
	dist_alcantarilla = 200
	dist_seguir_jugador = 500
